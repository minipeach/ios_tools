 ...
 */
typedef NS_ENUM (NSUInteger, ABCWaterfallLayoutItemRenderDirection) {
  ABCWaterfallLayoutItemRenderDirectionShortestFirst,
  ABCWaterfallLayoutItemRenderDirectionLeftToRight,
  ABCWaterfallLayoutItemRenderDirectionRightToLeft
};
...
extern NSString *const ABCElementKindSectionHeader;
/// A supplementary view that identifies the footer for a given section.
extern NSString *const ABCElementKindSectionFooter;

#pragma mark - ABCDelegateWaterfallLayout

@class ABCWaterfallLayout;

/**
 *  The TBSCollectionViewDelegateWaterfallLayout protocol defines methods that let you coordinate with a
 *  TBSCollectionViewWaterfallLayout object to implement a waterfall-based layout.
 ...
 */
@protocol ABCDelegateWaterfallLayout <UICollectionViewDelegate>
@required
/**
...
#pragma mark - TBSCollectionViewWaterfallLayout

/**
 *  The TBSCollectionViewWaterfallLayout class is a concrete layout object that organizes items into waterfall-based grids
 ...
 *  in each section. That delegate object must conform to the `TBSCollectionViewDelegateWaterfallLayout` protocol.
 *
 ...
 *
 *  @note TBSCollectionViewWaterfallLayout doesn't support decoration view, and it supports vertical scrolling direction only.
 */
@interface ABCWaterfallLayout : UICollectionViewLayout
 ...
 *  @discussion
 *    The direction in which each item is rendered. This could be left to right (TBSCollectionViewWaterfallLayoutItemRenderDirectionLeftToRight), right to left (TBSCollectionViewWaterfallLayoutItemRenderDirectionRightToLeft), or shortest column fills first (TBSCollectionViewWaterfallLayoutItemRenderDirectionShortestFirst).
 *
 *    Default: TBSCollectionViewWaterfallLayoutItemRenderDirectionShortestFirst
 */
@property (nonatomic, assign) ABCWaterfallLayoutItemRenderDirection itemRenderDirection;
